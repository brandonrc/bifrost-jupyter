...
# Change directory to the bifrost_jupyter directory
...
jupyter server extension enable bifrost_jupyter
...
jupyter server extension disable bifrost_jupyter
...
folder is located. Then you can remove the symlink named `bifrost-jupyter` within that folder.
...
```sh
pytest -vv -r ap --cov bifrost_jupyter
```
